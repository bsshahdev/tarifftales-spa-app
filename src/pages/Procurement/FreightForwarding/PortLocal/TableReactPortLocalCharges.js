...
import { GET_FCL_PLCHARGES_RESPONCE } from '../../../../store/Procurement/actiontype';
            ...
            <div className="freight_filter_wrap d-flex align-items-center">
                ...
                <div className="right_actions_wrap flex-shrink-0 d-flex align-items-center">
                    ...
                    <div className="add_btn">
                        <button className='border-0' onClick={() => { navidate(`/fcl/port-local/upload`);   dispatch({ type: GET_FCL_PLCHARGES_RESPONCE ,payload: {}}); }}>
