...
const TableOceanDetails = ({ columns, data, isGlobalFilter, customPageSize, addSurcharges, component, loader, setCurrentPage, totalPages, totalEntries }) => {
...
export default TableOceanDetails
