...
const TableAllFilesData = ({ columns, data, isGlobalFilter, customPageSize, addSurcharges, component, loader, setCurrentPage, totalPages, totalEntries }) => {
            ...
            <div className="freight_filter_wrap d-flex align-items-center">
                ...
                <div className="right_actions_wrap flex-shrink-0 d-flex align-items-center">
                    ...
                    {/* <div className="add_btn">
                        <button className='border-0' onClick={addSurcharges}>
...
export default TableAllFilesData
