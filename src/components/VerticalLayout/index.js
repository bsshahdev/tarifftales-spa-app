...
import { GET_CURRENCY_DETAIL, GET_OCEAEN_PORT_DATA, GET_OCEAN_PORT_TERMINAL_DETAILS, GET_SURCHARGE_CATEGORY_DATA, GET_SURCHARGE_CODE_DATA, GET_UOM_DATA, GET_VENDOR_DETAILS } from "../../store/Global/actiontype";
import { getTenantInfoData } from "../../store/Settings/actions";
import { GET_COMPANY_CITY_DATA } from "../../store/Settings/actiontype";
const Layout = props => {
  ...
  */
  ...
  useEffect(() => {
    ...
    dispatch({ type: GET_COMPANY_CITY_DATA });
    dispatch({ type: GET_SURCHARGE_CODE_DATA });
    dispatch({ type: GET_OCEAN_PORT_TERMINAL_DETAILS });
